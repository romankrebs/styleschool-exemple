  ...
  return (
    <div>
      <Helmet>
        ...
        <meta name="keywords" content="ВШС: Преподаватели" />
      </Helmet>
      <Page lable="Преподаватели" lableMobile="Преподаватели">
        <Grid container justify="center" alignItems="center">
          <Grid item xs={12} md={12} style={{ padding: 20 }}>
            <H2 content="Преподаватели" style={{ textAlign: "left" }} />
            <Person teachers={teachers} style={{}} />
          </Grid>
