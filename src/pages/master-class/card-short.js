  ...
  function CardInside(props) {
    return (
      <div style={styleBkg}>
        ...
        {props.subs ? <p style={styleButton}>Доступно по подписке</p> : null}
        {props.free ? (
          <img
        ...
        {props.q ? (
          <div style={styleLink}>{props.link ? "подробнее" : null}</div>
        ) : (
          <p style={styleLink}>Смотрите подробнее</p>
        )}
        {props.q && !props.noCorner ? <div style={styleCorner} /> : null}
      </div>
    );
  }
