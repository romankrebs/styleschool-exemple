      ...
      text: (
        <div style={{ textAlign: "left" }}>
          <h3 style={styles.head}>
            Учитесь от 3000 руб. в месяц в рассрочку на 10 месяцев
          </h3>
          <List
            style={styles.text}
            arr={[
              <span>Полная стоимость обучения: 30000 рублей</span>,
              <span>
                Как платить: Вы вносите аванс, бронируете место, начинаете
                учится; полную оплату курса необходимо внести до 3 занятия.
              </span>,
              <span>
                Доступна банковская рассрочка на 10 месяцев: 3000 рублей в
                месяц. (без переплаты),
              </span>,
              <span>
